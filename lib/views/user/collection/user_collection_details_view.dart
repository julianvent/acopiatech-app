    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          Center(
            child:
                collection.status == "En recolección"
                    ? Padding(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        (collection.status == "Recibida ")
                            ? "Agregar detalles de la recolección"
                            : "Tu recolección ha sido enviada y recibida por el equipo de Acopiatech, "
                                "recuerda estar atento a las notificaciones de la aplicación.",
